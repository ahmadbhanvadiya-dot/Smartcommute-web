...
/*
|--------------------------------------------------------------------------
| Demo live transport data
|--------------------------------------------------------------------------
|
| This is intentionally deterministic demo data for the SIH prototype.
| Later, this component can consume data from the FastAPI backend.
|
*/
      ...
      <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Estimated public transport availability
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-[11px] text-slate-500">
              ...
              SmartCommute is checking estimated
